              ...
              if (typeof loanPick == 'undefined') {
                ...
                console.log(impact_index);
                 ...
                 res.render('index', {
                  ...
                  Agriculture: Math.round((parseFloat(impact_index["Agriculture"]) * 1000)) / 1000,
                  Arts: Math.round((parseFloat(impact_index["Arts"]) * 1000)) / 1000,
                  Clothing: Math.round((parseFloat(impact_index["Clothing"]) * 1000)) / 1000,
                  Construction: Math.round((parseFloat(impact_index["Construction"]) * 1000)) / 1000,
                  Education: Math.round((parseFloat(impact_index["Education"]) * 1000)) / 1000,
                  Entertainment: Math.round((parseFloat(impact_index["Entertainment"]) * 1000)) / 1000,
                  Food: Math.round((parseFloat(impact_index["Food"]) * 1000)) / 1000,
                  Health: Math.round((parseFloat(impact_index["Health"]) * 1000)) / 1000,
                  Housing: Math.round((parseFloat(impact_index["Housing"]) * 1000)) / 1000,
                  Manufacturing: Math.round((parseFloat(impact_index["Manufacturing"]) * 1000)) / 1000,
                  Personal: Math.round((parseFloat(impact_index["Personal Use"]) * 1000)) / 1000,
                  Retail: Math.round((parseFloat(impact_index["Retail"]) * 1000)) / 1000,
                  Services: Math.round((parseFloat(impact_index["Services"]) * 1000)) / 1000,
                  Transportation: Math.round((parseFloat(impact_index["Transportation"]) * 1000)) / 1000,
                  Wholesale: Math.round((parseFloat(impact_index["Wholesale"]) * 1000)) / 1000
                  });
              }
